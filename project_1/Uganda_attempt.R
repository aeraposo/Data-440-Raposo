...
uga_int  <- read_sf("gadm36_UGA_shp/gadm36_UGA_0.shp")
...
ggplot() +
  geom_sf(data = uga_int, size = 1.5, color = 'gold', fill = 'green', alpha = 0.5)
...
ggplot() +
  geom_sf(data = uga_int,
          ...
          fill = "green",
          alpha = 0.5) +
  geom_sf_text(data = uga_int,
               aes(label = NAME_0),
               size = 10,
               color = "black")

# plot subcountries
uga_adm1  <- read_sf("gadm36_UGA_shp/gadm36_UGA_1.shp")

ggplot() +
  geom_sf(data = uga_adm1,
          size = 0.65,
          color = "blue",
          fill = "blue",
          alpha = 0.65) +
...
uga_adm2  <- read_sf("gadm36_UGA_shp/gadm36_UGA_3.shp")


ggplot() +
  geom_sf(data = uga_adm2,
          size = 0.65,
          color = "red",
          fill = "pink",
          alpha = 0.65) +
